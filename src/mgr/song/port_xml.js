function SongPortXML(r, t, s, u) {
  ...
  function o(t) {
    var u = new vvw.song.Song();
    var C = t.getElementsByTagName("song").length;
    var x = true;
    for (var y = 0; y < C; y++) {
      var A = t
        .getElementsByTagName("song")
        [y].getElementsByTagName("category")[0].textContent;
      if (!specialCategory(A)) {
        u.name = t
          .getElementsByTagName("song")
          [y].getElementsByTagName("name")[0].textContent;
        u.catIndex = t
          .getElementsByTagName("song")
          [y].getElementsByTagName("category")[0].textContent;
        var z = false;
        if (!z) {
          ...
          u.font = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("font")[0].textContent;
          var s = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("font2")[0];
          if (s != null) {
          ...
          var B = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("timestamp")[0];
          if (B != null) {
          ...
          var r = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("yvideo")[0];
          if (r != null) {
          ...
          u.bkgnd_fname = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("bkgnd")[0].textContent;
          u.key = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("key")[0].textContent;
          u.copyright = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("copyright")[0].textContent;
          u.notes = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("notes")[0].textContent;
          u.slides = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("slide")[0].textContent;
          var v = t
            .getElementsByTagName("song")
            [y].getElementsByTagName("slide2")[0];
          if (v != null) {
          ...
          u.slideseq = w(
            t
              .getElementsByTagName("song")
              [y].getElementsByTagName("slideseq")[0]
          );
          u.subcat = w(
